# Excell Customer App OpenAPI Specification
[![Build Status](https://travis-ci.com/excell/api/app/customer.svg?branch=master)](https://travis-ci.com/excell/api/app/customer)
## Steps to finish
...
- [Reference Documentation (ReDoc)](https://excell.github.io/api/)
- [SwaggerUI](https://excell.github.io/api/swagger-ui/)
- OpenAPI Raw Files: [JSON](https://excell.github.io/api/openapi.json) [YAML](https://excell.github.io/api/openapi.yaml)
